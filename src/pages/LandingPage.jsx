...
const LandingPage = () => {
  ...
  //             <div class="mt-4">
  //               <h4 id="client-id" class="text-base font-extrabold">{Text}</h4>
  //               {/* <p class="text-xs mt-1">{Value}</p> */}
  //               <div class="space-x-4 mt-4">
  //                 <button
  //                   type="button"
  //                   onClick={handleRemoveClient}
  //                   class="px-6 py-2.5 rounded text-white text-sm tracking-wider font-semibold border-none outline-none bg-slate-600 hover:bg-indigo-700 active:bg-slate-600">
  //                   <span class="border-r border-white pr-3">Remove</span>
  //                   <svg xmlns="http://www.w3.org/2000/svg" width="12px" fill="#fff" class="ml-3 inline" viewBox="0 0 320.591 320.591">
  //                     <path
              ...
              <div className="relative w-auto my-6 mx-auto max-w-6xl">
                ...
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                  ...
                  <div className="relative p-6 flex-auto">
                    <div class="font-[sans-serif] text-[#333] bg-gray-50">
                      <div class="lg:max-w-7xl max-w-2xl mx-auto p-4">
                        <h2 class="text-3xl font-extrabold text-center">Client Contacts</h2>
                        <div class="grid lg:grid-cols-2 grid-cols-1 gap-8 max-md:justify-center mt-12">
                          <div class="flex items-center max-sm:flex-col">
                            <img src="https://readymadeui.com/team-1.webp" class="w-full sm:h-60 rounded object-contain object-top" />
                            <div class="p-4 sm:ml-4">
                              ...
                              <div class="space-x-4 mt-4">
                                <button type="button"
                                  class="w-7 h-7 inline-flex items-center max-sm:flex-col justify-center rounded-full border-none outline-none bg-blue-600 hover:bg-blue-700 active:bg-blue-600">
                                ...
                                <button type="button"
                                  class="w-7 h-7 inline-flex items-center max-sm:flex-col justify-center rounded-full border-none outline-none bg-[#03a9f4] hover:bg-[#03a1f4] active:bg-[#03a9f4]">
                                ...
                                <button type="button"
                                  class="w-7 h-7 inline-flex items-center max-sm:flex-col justify-center rounded-full border-none outline-none bg-[#0077b5] hover:bg-[#0055b5] active:bg-[#0077b5]">
                          ...
                          <div class="flex items-center max-sm:flex-col">
                            <img src="https://readymadeui.com/team-3.webp" class="w-full sm:h-60 rounded object-contain object-top" />
                            <div class="p-4 sm:ml-4">
                          ...
                          <div class="flex items-center max-sm:flex-col">
                            <img src="https://readymadeui.com/team-4.webp" class="w-full sm:h-60 rounded object-contain object-top" />
                            <div class="p-4 sm:ml-4">
                          ...
                          <div class="flex items-center max-sm:flex-col">
                            <img src="https://readymadeui.com/team-5.webp" class="w-full sm:h-60 rounded object-contain object-top" />
                            <div class="p-4 sm:ml-4">
