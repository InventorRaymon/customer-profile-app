...
const ClientContactInfo = () => {
    ...
    const [historModal, setHistoryModal] = useState('hidden');
                                                    ...
                                                    <div className="flex items-center space-x-1">
                                                        <label className="font-semibold text-xs text-slate-500 ml-2">Contact Number:
                                                            <div className='flex flex-col justify-end'>
                                                                ...
                                                                <div onClick={handleViewHistory} id={contactInfo.Id} className="absolute top-[120px] right-[2px] sm:right-[30px] md:right-[55px] lg:right-[55px] xl:right-[55px] m-2 flex items-center justify-center rounded-md bg-slate-100 cursor-pointer">
                                                                    (View History)
