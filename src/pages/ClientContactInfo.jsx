...
const ClientContactInfo = () => {
    ...
    const [onEditModeInfo, setOnEditModeInfo] = useState('block');
    ...
    return (
        <>
            <header class='shadow-md font-[sans-serif] tracking-wide relative z-50'>
                <section
                    class='md:flex lg:items-center relative py-3 lg:px-10 px-4 border-gray-200 border-b bg-white lg:min-h-[80px] max-lg:min-h-[60px] bg-gradient-to-r from-slate-900 via-slate-500 via-50% to-slate-900 to 90%'>

                    <div className="flex-auto my-auto cursor-pointer" onClick={Navigate}>
                        <img
                            src="https://cdn.builder.io/api/v1/image/assets/TEMP/38729f07d05db3f41c27ee156c71cd47b20092f86cd671e4bd60abbf7867104d" alt="logo"
                            class='shrink w-64 h-14' />
            ...
            <div class="font-[sans-serif] text-[#333] bg-gray-50 p-4">
                <div class="max-w-5xl max-sm:max-w-sm mx-auto">
                    <h2 class="text-4xl font-extrabold flex-center">Client Contacts</h2>
                    <button type="button"
                    ...
                    <div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-8 text-center mt-12">
                        ...
                        {contactsData && contactsData.map((contactInfo) => {
                            ...
                            return (
                                <>
                                    <div key={contactInfo.Id} id="parentElement" class="bg-slate-200 py-4 px-2 rounded-md">
                                        <div class="mt-4">
                                            <div class="bg-white py-4 px-2 rounded-md ">
                                                <img src={contactInfo.ProfileImage} alt='Img Error' class="w-36 h-36 rounded-full inline-block" />
                                                <div className={onEditModeInfo}>
                                                <h4 class="text-lg font-bold">{contactInfo.ContactPerson}</h4>
                                                <h3 class="text-md font-bold">{contactInfo.Position}</h3>
                                                <p class="text-xs text-gray-600 mt-1">{contactInfo.ContactNumber}</p>
                                                <p class="text-xs text-gray-600 mt-1">{contactInfo.ContactNumber}</p>
                                                <p class="text-xs text-gray-600 mt-1">{contactInfo.ContactNumber}</p>
                                                <div class="mt-2 font-[sans-serif] w-max mx-auto bg-gray-200 border divide-x divide-white flex rounded overflow-hidden">
                                                    ...
                                                    <button type="button"
                                                        class="px-4 py-2.5 flex items-center text-[#333] text-sm font-semibold outline-none hover:bg-gray-300 transition-all">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="12px" fill="#000000" class="ml-3 inline" viewBox="0 0 320.591 320.591">
                                                            <path
                    ...
                    <form class="font-[sans-serif] m-6 max-w-4xl mx-auto">
                        {selectedImage && (
                            <div className='bg-white py-4 px-2 rounded-md hover:scale-110 transition-all duration-500'>
                                ...
                                />
                                <br />
                                <button className='hover:text-red-500' onClick={() => setSelectedImage(null)}>Remove</button>
                            </div>
                        )}
