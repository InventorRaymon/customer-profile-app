            ...
            <div class="font-[sans-serif] text-[#333] bg-gray-50 p-4">
                <div class="max-w-5xl max-sm:max-w-sm mx-auto">
                    ...
                    <div class="grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-2 gap-8 text-center mt-12">
                        ...
                        {dummyArray && dummyArray.map((contactInfo) => {
                                    ...
                                    <div key={contactInfo.Id} id="parentElement" class="bg-slate-200 py-4 px-2 rounded-md">
                                        <div class="mt-4">
                                            <div class="bg-white py-4 px-2 rounded-md ">
                                                ...
                                                <img src="https://picsum.photos/id/1/200/300" alt='Img Error' class="w-36 h-36 rounded-sm inline-block" />
                                                        ...
                                                        <div class="grid sm:grid-cols-2 gap-10">
                                                            ...
                                                            <div class="relative flex items-center sm:col-span-2">
                                                                ...
                                                                <input
                                                                    ...
                                                                    // name='birthdate'
                                                                    disabled
                                                                    value={formattedBirthday? formattedBirthday : contactInfo.birthdate}
